                          ...
                          StreamBuilder<QuerySnapshot>(
                            ...
                            builder: (context, foodSnapshot) {
                              ...
                              return ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  final foodItem =
                                  foodItems[index].data() as Map<String,
                                      dynamic>;
                                  final foodItemText =
        ...
        return AlertDialog(
          ...
          actions: <Widget>[
            ElevatedButton(
              onPressed: () {
                if (meal.isNotEmpty) {
                  final mealDate = DateFormat('yyyy-MM-dd').format(selectedDate);
...
Image getGreetingSymbol() {
    ...
    return Image.asset('assets/food.png'); // Replace 'sun.png' with the actual image asset path
